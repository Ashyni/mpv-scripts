...
fix_windowed_behavior: [0-3] - this function try avoiding the default behavior,
    that resize the window to the source size when cropping in windowed/maximized mode.
